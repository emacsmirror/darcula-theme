...
(custom-theme-set-faces
 ...
 '(smerge-mine ((t (:background "#303030"))))
 '(smerge-other ((t (:background "#303030"))))
 '(smerge-refined-removed ((t (:background "#46382c"))))
 '(smerge-refined-added ((t (:background "#343d32"))))
 ...
 '(ediff-current-diff-A ((t (:background "#303030"))))
 '(ediff-current-diff-B ((t (:background "#303030"))))
 '(ediff-current-diff-C ((t (:background "#303030"))))
 '(ediff-fine-diff-A ((t (:background "#46382c"))))
 '(ediff-fine-diff-B ((t (:background "#343d32"))))
 '(ediff-fine-diff-C ((t (:background "#313939"))))
 '(ediff-odd-diff-A ((t (:background "#303030"))))
 '(ediff-odd-diff-B ((t (:background "#303030"))))
 '(ediff-odd-diff-C ((t (:background "#303030"))))
 '(ediff-even-diff-A ((t (:background "#404040"))))
 '(ediff-even-diff-B ((t (:background "#404040"))))
 '(ediff-even-diff-C ((t (:background "#404040"))))
